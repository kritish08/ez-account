...
const AlertDialogContent = React.forwardRef(({ className, ...props }, ref) => (
  <AlertDialogPortal>
    ...
    <AlertDialogPrimitive.Content
      ref={ref}
      className={cn(
        // Same height bound as DialogContent — see the note there. The
        // factory-reset and backup-restore confirmations both live in this
        // primitive and both carry a password field plus a typed phrase, so
        // they are among the tallest surfaces in the app.
