...
import { getSuppliers, createSupplier, createSupplierPayment, formatCurrency } from "../lib/api";
...
import { Plus, Search, Truck, Loader2, Phone, CreditCard, Banknote, Building2 } from "lucide-react";
            ...
            <form onSubmit={handleSubmit} className="space-y-4 mt-4">
              ...
              <div className="flex justify-end gap-3 pt-4">
                ...
                <Button type="submit" className="bg-brand-600 hover:bg-brand-700" disabled={saving} data-testid="save-supplier-btn">
                  {saving ? <><Loader2 className="mr-2 h-4 w-4 animate-spin" />Saving...</> : "Add Supplier"}
                </Button>
              </div>
            </form>
          </DialogContent>
